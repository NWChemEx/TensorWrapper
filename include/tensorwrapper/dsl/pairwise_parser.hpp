...
//  *  which contain at most two connected nodes, i.e., considering each
//  operation
...
//      *
//      *  @tparam T The type of the expression on the left side of the "+"
//      sign.
//      *  @tparam U The type of the expression on the right side of the "+"
//      sign.
//      *
//      *  @param[in] lhs The object that @p rhs will ultimately be assigned to.
...
// protected:
//     labeled_type add(labeled_type result, labeled_type lhs, labeled_type
//     rhs);
// };
