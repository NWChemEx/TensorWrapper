...
/** @brief Fills in the provided tile with the appropriate sum of elements from
 * the tensor-of-tensor
 *
 *  The sparse map is used to obtain the correct "corresponding" elements from
 ...
 */
template<typename T>
auto reduce_tot_sum(const SparseMap<TileIndex, TileIndex>& tsm, const T& t_of_t,
