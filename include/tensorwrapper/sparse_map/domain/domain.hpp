...
public:
     ...
     *         from this Domain.
     *
     *  This function will compute the extents for the tensor that results
     *  from deleting all elements besides those in this Domain.
     *
     ...
     */
    Domain inject(const std::map<size_type, size_type>& injections) const;
