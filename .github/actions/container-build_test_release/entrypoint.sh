...
if [ "${USE_CLANG}" = true ]; then
   docker build -t ghcr.io/nwchemex-project/release_tensorwrapper:clang-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_tensorwrapper:clang-latest
else
   docker build -t ghcr.io/nwchemex-project/release_tensorwrapper:gcc-latest -f release.Dockerfile .
   docker push ghcr.io/nwchemex-project/release_tensorwrapper:gcc-latest
fi
