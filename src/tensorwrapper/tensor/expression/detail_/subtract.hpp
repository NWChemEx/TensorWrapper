...
public:
    /// Type used to label tensor modes. Ultimately set by the value of
...
protected:
    /// Implements labels() by returning @p lhs_labels
     ...
     *  @param[in] alloc The allocator of the output tensor
     */
