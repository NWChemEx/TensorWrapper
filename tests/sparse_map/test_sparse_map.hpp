...
using index_type_tuple_t =
  std::tuple<tensorwrapper::sparse_map::ElementIndex, tensorwrapper::sparse_map::TileIndex>;
...
using index_pairs_tuple_t =
  index_pairs_tuple_t_<tensorwrapper::sparse_map::ElementIndex,
                       tensorwrapper::sparse_map::TileIndex>;
