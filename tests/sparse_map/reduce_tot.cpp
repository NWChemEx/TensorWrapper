/// TODO: Remove if reduce_tot is removed, otherwise needs updating
// #include "tensorwrapper/sparse_map/reduce_tot.hpp"
...
//             REQUIRE_THROWS_AS(make_reduced_tile_(tile, bad_sm, trange,
//             t_of_t),
//                               std::runtime_error);
//         }
//     }
...
// //         // Make the sparse map
// //         ei e0{0}, e1{1}, e2{2}, e3{3};
// //         SparseMap<ei, ei> sm({{e0, {e1, e3}}, {e1, {e1, e2}}, {e2,
// {e0}}});

// //         // Make ToT
// //         TA::TiledRange tot_trange{{0, 3}};
// //         TA::detail::vector_il<inner_tile> corr_il{
// //           inner_tile{TA::Range{2}, {1, 3}}, inner_tile{TA::Range{2}, {1,
// 2}},
// //           inner_tile{TA::Range{1}, {5}}};
// //         tot_type t_of_t(world, tot_trange, corr_il);
