...
void contraction_assignment_tests() {
    ...
    SECTION("scalar,scalar->") {
        ...
        REQUIRE(
          elements_equal(scalar.get_elem({}), scalar_value_type(42.0 * 42.0)));
    }
    ...
    SECTION("i,i->") {
        ...
        REQUIRE(elements_equal(scalar.get_elem({}), vector_value_type(5.0)));
    }
    ...
    SECTION("i,ij->j") {
        ...
        REQUIRE(elements_equal(vector.get_elem({0}), vector_value_type(7.0)));
        REQUIRE(elements_equal(vector.get_elem({1}), vector_value_type(10.0)));
    }
    ...
    SECTION("ij,ji->") {
        ...
        REQUIRE(elements_equal(scalar.get_elem({}), matrix_value_type(29.0)));
    }
    ...
    SECTION("ij,jk->ik") {
        ...
        REQUIRE(
          elements_equal(matrix.get_elem({0, 0}), matrix_value_type(7.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({0, 1}), matrix_value_type(10.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 0}), matrix_value_type(15.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 1}), matrix_value_type(22.0)));
    }
    ...
    SECTION("ijk,ijk->") {
        ...
        REQUIRE(elements_equal(scalar.get_elem({}), scalar_value_type(204.0)));
    }
    ...
    SECTION("ijk,jik->") {
        ...
        REQUIRE(elements_equal(scalar.get_elem({}), scalar_value_type(196.0)));
    }
    ...
    SECTION("ijk,jkl->il") {
        ...
        REQUIRE(
          elements_equal(matrix.get_elem({0, 0}), matrix_value_type(50.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({0, 1}), matrix_value_type(60.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 0}), matrix_value_type(114.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 1}), matrix_value_type(140.0)));
    }
    ...
    SECTION("ijk,jlk->il") {
        ...
        REQUIRE(
          elements_equal(matrix.get_elem({0, 0}), matrix_value_type(44.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({0, 1}), matrix_value_type(64.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 0}), matrix_value_type(100.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 1}), matrix_value_type(152.0)));
    }
    ...
    SECTION("ijk,jlk->li") {
        ...
        REQUIRE(
          elements_equal(matrix.get_elem({0, 0}), matrix_value_type(44.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({0, 1}), matrix_value_type(100.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 0}), matrix_value_type(64.0)));
        REQUIRE(
          elements_equal(matrix.get_elem({1, 1}), matrix_value_type(152.0)));
    }
    ...
    SECTION("ijk,ljm->iklm") {
        ...
        REQUIRE(elements_equal(tensor4.get_elem({0, 0, 0, 0}),
                               tensor4_value_type(10.0)));
        REQUIRE(elements_equal(tensor4.get_elem({0, 0, 0, 1}),
                               tensor4_value_type(14.0)));
        REQUIRE(elements_equal(tensor4.get_elem({0, 0, 1, 0}),
                               tensor4_value_type(26.0)));
        REQUIRE(elements_equal(tensor4.get_elem({0, 0, 1, 1}),
                               tensor4_value_type(30.0)));
        REQUIRE(elements_equal(tensor4.get_elem({0, 1, 0, 0}),
                               tensor4_value_type(14.0)));
        REQUIRE(elements_equal(tensor4.get_elem({0, 1, 0, 1}),
                               tensor4_value_type(20.0)));
        REQUIRE(elements_equal(tensor4.get_elem({0, 1, 1, 0}),
                               tensor4_value_type(38.0)));
        REQUIRE(elements_equal(tensor4.get_elem({0, 1, 1, 1}),
                               tensor4_value_type(44.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 0, 0, 0}),
                               tensor4_value_type(26.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 0, 0, 1}),
                               tensor4_value_type(38.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 0, 1, 0}),
                               tensor4_value_type(74.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 0, 1, 1}),
                               tensor4_value_type(86.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 1, 0, 0}),
                               tensor4_value_type(30.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 1, 0, 1}),
                               tensor4_value_type(44.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 1, 1, 0}),
                               tensor4_value_type(86.0)));
        REQUIRE(elements_equal(tensor4.get_elem({1, 1, 1, 1}),
                               tensor4_value_type(100.0)));
    }
    ...
    SECTION("ij,jkl->ikl") {
        ...
        REQUIRE(elements_equal(tensor3.get_elem({0, 0, 0}),
                               tensor3_value_type(11.0)));
        REQUIRE(elements_equal(tensor3.get_elem({0, 0, 1}),
                               tensor3_value_type(14.0)));
        REQUIRE(elements_equal(tensor3.get_elem({0, 1, 0}),
                               tensor3_value_type(17.0)));
        REQUIRE(elements_equal(tensor3.get_elem({0, 1, 1}),
                               tensor3_value_type(20.0)));
        REQUIRE(elements_equal(tensor3.get_elem({1, 0, 0}),
                               tensor3_value_type(23.0)));
        REQUIRE(elements_equal(tensor3.get_elem({1, 0, 1}),
                               tensor3_value_type(30.0)));
        REQUIRE(elements_equal(tensor3.get_elem({1, 1, 0}),
