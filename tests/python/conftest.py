...
# py_test_tensorwrapper is a NO_INSTALL pybind11 module (test-only fixtures)
# that only ever lands in the CMake build directory, never in site-packages.
# Make it importable here.
