        ...
        SECTION("one tile matrix") {
            ...
            SECTION("[(0,0), (2,2))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{1, 2}, vector_il{7, 8}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,0), (2,3))") {
                auto r = slice(t, idx_type{0, 0}, idx_type{2, 3});
                tensor_type corr(
                  world, matrix_il{vector_il{1, 2, 3}, vector_il{7, 8, 9}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,0), (2,6))") {
                auto r = slice(t, idx_type{0, 0}, idx_type{2, 6});
                tensor_type corr(world,
                                 matrix_il{vector_il{1, 2, 3, 4, 5, 6},
                                           vector_il{7, 8, 9, 10, 11, 12}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,0), (3,1))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{1}, vector_il{7}, vector_il{13}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,0), (3,5))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{1, 2, 3, 4, 5},
                                           vector_il{7, 8, 9, 10, 11},
                                           vector_il{13, 14, 15, 16, 17}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,0), (4,1))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{1}, vector_il{7},
                                           vector_il{13}, vector_il{19}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,0), (4,2))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{1, 2}, vector_il{7, 8},
                                   vector_il{13, 14}, vector_il{19, 20}});
                REQUIRE(allclose(r, corr));
            }
    ...
    SECTION("Upper index is on boundary") {
        ...
        SECTION("one tile matrix") {
            ...
            SECTION("[(0,1), (4,6))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{2, 3, 4, 5, 6},
                                           vector_il{8, 9, 10, 11, 12},
                                           vector_il{14, 15, 16, 17, 18},
                                           vector_il{20, 21, 22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }

            SECTION("[(0,2), (4,6))") {
                auto r = slice(t, idx_type{0, 2}, idx_type{4, 6});
                tensor_type corr(world, matrix_il{vector_il{3, 4, 5, 6},
                                                  vector_il{9, 10, 11, 12},
                                                  vector_il{15, 16, 17, 18},
                                                  vector_il{21, 22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }

            SECTION("[(0,3), (4,6))") {
                auto r = slice(t, idx_type{0, 3}, idx_type{4, 6});
                tensor_type corr(world, matrix_il{vector_il{4, 5, 6},
                                                  vector_il{10, 11, 12},
                                                  vector_il{16, 17, 18},
                                                  vector_il{22, 23, 24}});
                REQUIRE(allclose(r, corr));
            ...
            SECTION("[(0,4), (4,6))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{5, 6}, vector_il{11, 12},
                                   vector_il{17, 18}, vector_il{23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,5), (4,6))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{6}, vector_il{12},
                                           vector_il{18}, vector_il{24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,1), (4,6))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{8, 9, 10, 11, 12},
                                           vector_il{14, 15, 16, 17, 18},
                                           vector_il{20, 21, 22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,2), (4,6))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{9, 10, 11, 12},
                                                  vector_il{15, 16, 17, 18},
                                                  vector_il{21, 22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,3), (4,6))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{10, 11, 12},
                                                  vector_il{16, 17, 18},
                                                  vector_il{22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,4), (4,6))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{11, 12}, vector_il{17, 18},
                                           vector_il{23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,5), (4,6))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{12}, vector_il{18},
                                                  vector_il{24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,1), (4,6))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{14, 15, 16, 17, 18},
                                           vector_il{20, 21, 22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,2), (4,6))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{15, 16, 17, 18},
                                                  vector_il{21, 22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,3), (4,6))") {
                auto r = slice(t, idx_type{2, 3}, idx_type{4, 6});
                tensor_type corr(world, matrix_il{vector_il{16, 17, 18},
                                                  vector_il{22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,4), (4,6))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{17, 18}, vector_il{23, 24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,5), (4,6))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{18}, vector_il{24}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(3,1), (4,6))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{20, 21, 22, 23, 24}});
                REQUIRE(allclose(r, corr));
            }
    ...
    SECTION("Neither index is on boundary") {
        ...
        SECTION("one tile matrix") {
            ...
            SECTION("[(0,1), (4,5))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{2, 3, 4, 5},
                                                  vector_il{8, 9, 10, 11},
                                                  vector_il{14, 15, 16, 17},
                                                  vector_il{20, 21, 22, 23}});
                REQUIRE(allclose(r, corr));
            }

            SECTION("[(0,2), (4,5))") {
                auto r = slice(t, idx_type{0, 2}, idx_type{4, 5});
                tensor_type corr(world, matrix_il{vector_il{3, 4, 5},
                                                  vector_il{9, 10, 11},
                                                  vector_il{15, 16, 17},
                                                  vector_il{21, 22, 23}});
                REQUIRE(allclose(r, corr));
            ...
            SECTION("[(0,3), (4,5))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{4, 5}, vector_il{10, 11},
                                   vector_il{16, 17}, vector_il{22, 23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,4), (4,5))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{5}, vector_il{11},
                                           vector_il{17}, vector_il{23}});
                REQUIRE(allclose(r, corr));
            }

            SECTION("[(1,1), (4,5))") {
                auto r = slice(t, idx_type{1, 1}, idx_type{4, 5});
                tensor_type corr(world, matrix_il{vector_il{8, 9, 10, 11},
                                                  vector_il{14, 15, 16, 17},
                                                  vector_il{20, 21, 22, 23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,2), (4,5))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{9, 10, 11},
                                                  vector_il{15, 16, 17},
                                                  vector_il{21, 22, 23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,3), (4,5))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{10, 11}, vector_il{16, 17},
                                           vector_il{22, 23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,4), (4,5))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{11}, vector_il{17},
                                                  vector_il{23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,1), (4,5))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{14, 15, 16, 17},
                                                  vector_il{20, 21, 22, 23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,2), (4,5))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{15, 16, 17},
                                                  vector_il{21, 22, 23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,3), (4,5))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{16, 17}, vector_il{22, 23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,4), (4,5))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{17}, vector_il{23}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,1), (4,4))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{2, 3, 4},
                                                  vector_il{8, 9, 10},
                                                  vector_il{14, 15, 16},
                                                  vector_il{20, 21, 22}});
                REQUIRE(allclose(r, corr));
            ...
            SECTION("[(0,2), (4,4))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{3, 4}, vector_il{9, 10},
                                   vector_il{15, 16}, vector_il{21, 22}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(0,3), (4,4))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{4}, vector_il{10},
                                           vector_il{16}, vector_il{22}});
                REQUIRE(allclose(r, corr));
            }

            SECTION("[(1,1), (4,4))") {
                auto r = slice(t, idx_type{1, 1}, idx_type{4, 4});
                tensor_type corr(world, matrix_il{vector_il{8, 9, 10},
                                                  vector_il{14, 15, 16},
                                                  vector_il{20, 21, 22}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,2), (4,4))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{9, 10}, vector_il{15, 16},
                                           vector_il{21, 22}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(1,3), (4,4))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{10}, vector_il{16},
                                                  vector_il{22}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,1), (4,4))") {
                ...
                tensor_type corr(world, matrix_il{vector_il{14, 15, 16},
                                                  vector_il{20, 21, 22}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,2), (4,4))") {
                ...
                tensor_type corr(
                  world, matrix_il{vector_il{15, 16}, vector_il{21, 22}});
                REQUIRE(allclose(r, corr));
            }
            ...
            SECTION("[(2,3), (4,4))") {
                ...
                tensor_type corr(world,
                                 matrix_il{vector_il{16}, vector_il{22}});
                REQUIRE(allclose(r, corr));
            }
