...
TEST_CASE("linalg_inner_tensors") {
    ...
    SECTION("diagonalize") {
        ...
        inner_tile_type e0_evals(
          TA::Range(3),
          {-0.5157294715892564, 0.1709151888271797, 11.3448142827620728});
        inner_tile_type e0_evecs(
          r33, {0.7369762290995787, 0.5910090485061027, 0.3279852776056817,
        ...
        inner_tile_type e1_evals(TA::Range(2),
                                 {-0.2360679774997897, 4.2360679774997898});
    ...
    SECTION("cholesky_linv") {
        ...
        inner_tile_type e0_linv(r33,
                                {0.5, 0, 0, -3, 1, 0, 6.333333333333333,
                                 -1.6666666666666665, 0.33333333333333331});

        inner_tile_type e1(r22, {2, 1, 1, 2});
        inner_tile_type e1_linv(
          r22,
          {0.70710678118654746, 0, -0.40824829046386302, 0.81649658092772615});
